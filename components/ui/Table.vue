    ...
    <tr v-if="isLoading">
      <td :colspan="headers.length + 1" class="px-6 py-10 text-center">
        <div class="flex flex-col items-center justify-center space-y-3">
          ...
          <p class="text-sm text-slate-500">Memuat data, harap tunggu...</p>
        </div>
      </td>
    </tr>
    ...
    <template v-else>
      <tr
        ...
        <td
          ...
          <div v-if="key === 'actions'" class="flex items-center space-x-2">
            <button
          ...
          <div v-else-if="key === 'themes'" class="flex items-center">
            <img
      ...
      <tr v-if="paginatedData && paginatedData.length === 0">
        <td :colspan="headers.length + 1" class="py-10 text-center space-y-3">
          ...
          <p class="text-sm text-slate-500">
            Silakan tambahkan data atau coba ubah filter pencarian.
          </p>
        </td>
      </tr>
    </template>
