			...
			<div class="h-full flex flex-col">
				...
				<div
					...
					<div class="flex items-center space-x-2">
						...
						<button
							class=" bg-white rounded-full p-0" @click="showNav = !showNav">
							<img v-if="showNav" src="https://cdn-icons-png.flaticon.com/512/9179/9179580.png" width="15" alt="">
					...
					<button
						@click="toggleSidebar"
						class="p-1 rounded-md text-gray-500 hover:text-gray-700 lg:hidden">
						<svg
							class="w-6 h-6"
							fill="none"
							stroke="currentColor"
